...
for p,g_max,g_min in zip(nb_people,nb_Gen_Max,nb_Gen_Min):
    ...
    for nb in range(nb_ped):
        ...
        t1 = process_time()
        ie1 = lis.lisPosterior(f'../cplex/bn/LIS/bn_compact_{p}_{g}_{nbChild}_{cl}_G{nb}.bif')
        t2 = process_time()
        t2 = t2 - t1
        tab_lis[nb] = t2
        ie2 = laz.lazyPosterior(f'../cplex/bn/LIS/bn_compact_{p}_{g}_{nbChild}_{cl}_G{nb}.bif')
...
plt.savefig('../cplex/figure/LIS/proportion_20s_5e-4',bbox_inches='tight',dpi=300)
plt.show()
