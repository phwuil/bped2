...
centimorgans = [0.295797287184, 0.296353882133, 0.299343592142, 0.59, 0.59]
w = 0
...
evidence = {'X1_1':[1,0,0,0],'X5_1':[1,1,1,0],'X8_1':[1,1,1,0],'X3_3':[1,1,1,0],'X7_3':[0,1,1,0],'X1_4':[1,1,1,0],'X2_4':[0,1,1,0]}
#evidence = None
file = open('../data/multi/lbp/last_test2', 'w')
